...
class AffineTransformer:
    ...
    def _get_scale_factor(
        self, m1_hor_points, m1_ver_points, m2_hor_points, m2_ver_points
    ):
        """
    ...
    def to_m2(self, m1_point):
        ...
        """
        if self.success:
            m1_point_homogeneous = np.append(
                m1_point, 1
            )  # Convert to homogeneous coordinates
            return (
                np.dot(self.transform_matrix, m1_point_homogeneous) / self.scale_factor
            )
        else:
            return None
    ...
    def to_m1(self, m2_point):
        ...
        if self.success:
            ...
            m2_point_homogeneous = np.append(
                m2_point * self.scale_factor, 1
            )  # Convert to homogeneous coordinates
            m1_point_homogeneous = np.dot(
                inverse_affine_transform, m2_point_homogeneous
            )
