...
INTERNAL_EYES_CORNERS_MODEL = np.array([[-0.035, -0.05, 0], [0.035, -0.05, 0]])

OUTER_EYES_CORNERS_MODEL = np.array([[-0.09, -0.057, 0.01], [0.09, -0.057, 0.01]])

OUTER_HEAD_POINTS_MODEL = np.array([[-0.145, -0.1, 0.1], [0.145, -0.1, 0.1]])

NOSE_BRIDGE_MODEL = np.array([[0, -0.0319, -0.0432]])

NOSE_TIP_MODEL = np.array([[0, 0.088, -0.071]])
...
DEFAULT_LEFT_EYE_CENTER_MODEL = (
    np.array(INTERNAL_EYES_CORNERS_MODEL[0]) + np.array(OUTER_EYES_CORNERS_MODEL[0])
) * 0.5
DEFAULT_LEFT_EYE_CENTER_MODEL[1] -= 0.009
DEFAULT_LEFT_EYE_CENTER_MODEL[2] = 0.02

DEFAULT_RIGHT_EYE_CENTER_MODEL = (
    np.array(INTERNAL_EYES_CORNERS_MODEL[1]) + np.array(OUTER_EYES_CORNERS_MODEL[1])
) * 0.5
